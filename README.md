# Hugo AI Suite v6.3.35 - Huong Dan Su Dung & Cai Dat
...
- Sau khi nhan file ban quyen `*.lic` tu Admin (qua Telegram: **@Hugo997911**), hay chep truc tiep file `.lic` nay vao **cung thu muc** voi file `hugoai_6.3.35.exe`.
...
1. **Quyen quan tri (Administrator):** Luon click chuot phai vao file `hugoai_6.3.35.exe` va chon **Run as Administrator**.
